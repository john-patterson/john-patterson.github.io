...
export const jobs: Job[] = [
  ...
  },
  {
    ...
    location: "Redmond, WA",
    highlights: [
      "Led a squad of 5 engineers building a compiler for Office test-spec validation — setting technical direction and architecture, mentoring, and staying hands-on in the code.", // verify
